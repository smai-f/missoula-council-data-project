...
1.  Generate a Google Service Account JSON Key for your Google Cloud Project.
    ...
    add a file called `missoula-council-data-proj.json` to it
    (i.e. `.keys/missoula-council-data-proj)`. This file will be used later on.
...
1.  Once the
    ...
    -   Navigate to [Firebase Console](https://console.firebase.google.com),
        login to the Google Account you used during step #2, select the `missoula-council-data-proj` Firebase project
