...
1.  Create (or re-use) a
    [Google Cloud billing account](https://console.cloud.google.com/billing/linkedaccount?project=missoula-mt-council-data)
    and attach it to the newly created project (missoula-mt-council-data).
...
1.  Generate a Google Service Account JSON Key for your Google Cloud Project.
    ...
    add a file called `missoula-mt-council-data.json` to it
    (i.e. `.keys/missoula-mt-council-data)`. This file will be used later on.
...
1.  Attach the Pulumi Access Token and the
    ...
    -   Set the value to: the contents of the file `.keys/missoula-mt-council-data.json`
    -   Click "Add secret"
...
1.  Once the
    ...
    [Direct Link to Enable](https://console.cloud.google.com/apis/api/speech.googleapis.com/data_logging?project=missoula-mt-council-data)
...
1.  Once the
    ...
    -   Navigate to [Firebase Console](https://console.firebase.google.com),
        login to the Google Account you used during step #2, select the `missoula-mt-council-data` Firebase project
